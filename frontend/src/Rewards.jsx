    ...
    <div className="flex flex-col items-center justify-center h-full w-full animate-fade-in">
      <div className="w-full max-w-2xl bg-[#23272f] rounded-2xl shadow-2xl p-8 md:p-14 border border-[#2e323c] mb-10 animate-fade-in relative overflow-hidden mt-4 md:mt-0">
        ...
        <p className="text-lg md:text-xl text-gray-200 mb-6 text-center">
          Aura Points rewards the sharpest traders every week with a share of <span className="text-yellow-300 font-bold glow-green">10 SOL</span>.<br />
          Rankings are determined purely by your <span className="text-green-300 font-bold glow-green">Aura Points</span> score — which measures consistency and profitability on Solana memecoins.
        </p>
        ...
        <div className="mb-6">
          <h3 className="text-xl font-bold text-green-300 mb-2 glow-green">💰 Weekly Reward Breakdown:</h3>
